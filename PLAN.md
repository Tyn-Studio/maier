...
- [~] **T14** *(mechanics done; blocked on name + license decisions)* PyPI packaging + publish workflow; PyInstaller specs (macOS/Windows/Linux) + GitHub Actions release matrix + bundle smoke test; README install docs. Resolve open questions: final name, license.
